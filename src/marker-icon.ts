...
// mdi:lightning-bolt — used by the lightning overlay for individual strikes.
// We use the filled variant (vs. -outline) and apply BOTH fill (age-derived
// colour) and stroke (HA --primary-text-color) ourselves — the design calls
// for an "outline" appearance via a coloured fill plus a dark stroke, which
// the filled MDI shape with stroke styling delivers. See lightning-feature-design.md.
