...
| progress_bar_touch_height | number          | **Optional**   | YAML-only. Height in pixels of the tappable/draggable timeline region. The visible segmented track remains 8 px high; enlarge this for touchscreen use. Values smaller than 8 are treated as 8.                                                       | `8`                                   |
